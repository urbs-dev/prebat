        ...
        <section>
            ...
            <form>  
                <aside class="input-field">
                    ...
                    <label for="icon_login">Mot de passe *</label>
                </aside>
                <aside class="input-field">
                    <i class="material-icons prefix">check_circle</i>
                    <input id="icon_password" type="password" class="field" bind:value={form.password_confirm}/>
                    <label for="icon_password">Confirmer le mot de passe *</label>
                </aside>
...
<style>
    ...
    article img{display:block;margin:24px auto 8px auto;width:56%;}
    ...
    p.title{margin:0 0 8px 0;color:#616161;text-transform:uppercase;text-align:center;}
    p.explain{color:#757575;}
    div.confirmed{border:1px solid #a5d6a7;font-size:16px;background:#e8f5e9;margin:32px auto;text-align:center;padding:16px 8px;border-radius:4px;}
    div.confirmed p{color:#4caf50;margin:24px auto;margin:8px 0;}
</style>